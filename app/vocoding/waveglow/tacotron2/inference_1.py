...
## WaveGlow 프로젝트 위치 설정
sys.path.append('C:/Users/YGL/Desktop/ksy/Web/app/vocoding/waveglow/tacotron2/waveglow/')
## Tacontron2 프로젝트 위치 설정
sys.path.append('C:/Users/YGL/Desktop/ksy/Web/app/vocoding/waveglow/tacotron2/')
...
class Synthesizer:
    def __init__(self, tacotron_check, waveglow_check):
        ...
        with open('C:/Users/YGL/Desktop/ksy/Web/app/vocoding/waveglow/tacotron2/waveglow/config.json') as f:
            data = f.read()
...
tacotron2_checkpoint = 'C:/Users/YGL/Desktop/ksy/Web/app/vocoding/waveglow/tacotron2/output/checkpoint_290000'
waveglow_checkpoint = 'C:/Users/YGL/Desktop/ksy/Web/app/vocoding/waveglow/tacotron2/output/waveglow_94000'
## 음성 합성 모듈 생성
synthesizer = Synthesizer(tacotron2_checkpoint, waveglow_checkpoint)

print('모델 로드 완료')

# sample_text = '가야 할 때가 언제인가를 분명히 알고 가는 이의 뒷모습은 얼마나 아름다운가.'
# audio, sampling_rate = synthesizer.inference(sample_text)
# write("example1.wav", sampling_rate, audio)

# sample_text = '안녕하세요.'
# audio, sampling_rate = synthesizer.inference(sample_text)
# write("example2.wav", sampling_rate, audio)

# sample_text = '오늘 날씨가 참 좋네요.'
# audio, sampling_rate = synthesizer.inference(sample_text)
# write("example3.wav", sampling_rate, audio)

# sample_text = '저는 머신러닝 엔지니어가 되고싶습니다.'
# audio, sampling_rate = synthesizer.inference(sample_text)
# write("example4.wav", sampling_rate, audio)
